...
type SortOption = "OUTSTANDING_DESC" | "OUTSTANDING_ASC" | "NAME_ASC" | "NAME_DESC";
...
export default function KolektibilitasTable({
  ...
  const [selectedKol, setSelectedKol] = useState<NpfKolektibilitasLevel | null>(null);
    ...
    <>
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-medium text-gray-900">Kol {item.level}</span>
                    </div>
                  </td>
      ...
      {selectedRow ? (
        <div
          ...
          className="fixed inset-0 z-[90] flex items-center justify-center bg-black/45 p-4 backdrop-blur-sm animate-fade-in"
          onClick={closeModal}
        >
          <div
              ...
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">
                    Nasabah Kol {selectedRow.level} - {selectedRow.shortLabel}
                  </h3>
                </div>
                <button
                  type="button"
