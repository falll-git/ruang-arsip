...
const SORT_OPTIONS: Array<{ value: "tanggal-desc" | "tanggal-asc"; label: string }> = [
  { value: "tanggal-desc", label: "Terbaru (Paling Baru)" },
  { value: "tanggal-asc", label: "Terlama (Paling Lama)" },
];

const personLookupEntries: Array<[string, string]> = [];
...
function getSearchPlaceholder(activeKind: DocumentKind) {
  ...
  if (activeKind === "surat-keluar") {
    return "Cari penerima, nomor surat, perihal...";
  }
...
export default function CetakDokumenClient() {
    ...
    () =>
      dummySuratKeluar.map((record) => {
        ...
        return {
          ...
          code: normalizedRecord.namaSurat,
          subject: normalizedRecord.perihal,
          primaryText: normalizedRecord.penerima,
          secondaryText: normalizedRecord.media,
          searchText: normalizeKeyword(
            [
              normalizedRecord.namaSurat,
  ...
  const handleOpenPreview = () => {
    ...
    openPreview(selectedRecord.fileUrl, selectedRecord.fileName);
  };
  ...
  const handlePrint = () => {
    ...
    if (!printStarted) {
      showToast("Popup browser terblokir. Izinkan popup untuk mencetak.", "error");
      return;
    }
            ...
            <div className="space-y-5">
                ...
                {selectedRecord.kind === "surat-masuk" ? (
                  <>
                    ...
                    <DetailField
                      ...
                      value={formatDateDisplay(selectedRecord.record.tanggalTerima)}
                    />
                    <DetailField
                  ...
                  <>
                    ...
                    <DetailField
                      ...
                      value={formatDateDisplay(selectedRecord.record.tanggalKirim)}
                    />
                    <DetailField
                  ...
                  <>
                    ...
                    <DetailField
                      label="Tanggal Memo"
                      value={formatDateDisplay(selectedRecord.record.tanggal)}
                    />
                    <DetailField
              ...
              <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-50">
                <iframe
                  ...
                  title={`Preview ${selectedRecord.fileName}`}
